...
// INSTRUCTION_L  : No operand register mapped function (no impl, in switch/case order)
// INSTRUCTION_E  : No operand register mapped function (end, so with impl)
...
// description, tick count (in cpu clocks), function name, op id, special code
 ...
 INSTRUCTION_2( "LD (0x%04X), SP", 			20,  ld_nnp_sp		,	0x08, {}			)
 ...
 INSTRUCTION_1( "STOP", 					4,   stop			,	0x10, {cpu.clocks -= (numInstr - i - 1) * 4; i = numInstr;}		)
 ...
 INSTRUCTION_1( "JR NZ, 0x%02X", 			4,   jr_nz_n		,	0x20, {}			)
 ...
 INSTRUCTION_1( "JR Z, 0x%02X", 			4,   jr_z_n			,	0x28, {}			)
 ...
 INSTRUCTION_1S("JR C, 0x%02X", 			4,   jr_c_n			,	0x38, {}			)
 ...
 INSTRUCTION_L( , 							 ,					,	0x44,				)
 INSTRUCTION_L( , 							 ,					,	0x45,				)
 INSTRUCTION_E( "LD B, %s", 				4,   ld_b			,	0x47, {}			)
 ...
 INSTRUCTION_L( ,		 					 ,					,	0x4c,				)
 INSTRUCTION_L( ,		 					 ,					,	0x4d,				)
 INSTRUCTION_E( "LD C, %s", 				4,   ld_c			,	0x4f, {}			)
 ...
 INSTRUCTION_L( ,		 					 ,					,	0x54,				)
 INSTRUCTION_L( ,		 					 ,					,	0x55,				)
 INSTRUCTION_E( "LD D, %s", 				4,   ld_d			,	0x57, {}			)
 ...
 INSTRUCTION_L(	, 							 ,					,	0x5c,				)
 INSTRUCTION_L(	, 							 ,					,	0x5d,				)
 INSTRUCTION_E( "LD E, %s", 				4,   ld_e 			,	0x5f, {}			)
 ...
 INSTRUCTION_L(	, 							 ,					,	0x64,				)
 INSTRUCTION_L(	, 							 ,					,	0x65,				)
 INSTRUCTION_E( "LD H, %s", 				4,   ld_h 			,	0x67, {}			)
 ...
 INSTRUCTION_L( ,		 					 ,					,	0x6d,				)
 INSTRUCTION_L( ,		 					 ,					,	0x68,				)
 INSTRUCTION_E( "LD L, %s", 				4,   ld_l			,	0x6f, {}			)
 ...
 INSTRUCTION_L( ,			 				 ,					,	0x74,				)
 INSTRUCTION_L( ,			 				 ,					,	0x75,				)
 INSTRUCTION_E( "LD (HL), %s", 				8,   ld_hlp			,	0x77, {}			)
 INSTRUCTION_0( "HALT", 					4,   halt			,	0x76, {cpu.clocks -= (numInstr - i - 1) * 4; i = numInstr;}		)
 INSTRUCTION_L( ,		 					 ,					,	0x78,				)
 INSTRUCTION_L( ,		 					 ,					,	0x79,				)
 INSTRUCTION_L( ,		 					 ,					,	0x7a,				)
 INSTRUCTION_L( ,		 					 ,					,	0x7b,				)
 INSTRUCTION_L( ,		 					 ,					,	0x7c,				)
 INSTRUCTION_L( ,		 					 ,					,	0x7d,				)
 INSTRUCTION_E( "LD A, %s", 				4,   ld_a			,	0x7f, {}			)
 ...
 INSTRUCTION_L( ,			 				 ,					,	0x84,				)
 INSTRUCTION_L( ,			 				 ,					,	0x85,				)
 INSTRUCTION_E( "ADD A, %s", 				4,   add_a			,	0x87, {}			)
 ...
 INSTRUCTION_L( ,							 ,					,	0x8c,				)
 INSTRUCTION_L( ,							 ,					,	0x8d,				)
 INSTRUCTION_E( "ADC A, %s", 				4,   adc			,	0x8f, {}			)
 ...
 INSTRUCTION_L( ,							 ,					,	0x94,				)
 INSTRUCTION_L( ,							 ,					,	0x95,				)
 INSTRUCTION_E( "SUB %s", 					4,   sub			,	0x97, {}			)
 ...
 INSTRUCTION_L( ,							 ,					,	0x9c,				)
 INSTRUCTION_L( ,							 ,					,	0x9d,				)
 INSTRUCTION_E( "SBC %s",					4,	 sbc			,	0x9f, {}			)
 ...
 INSTRUCTION_L( ,							 ,					,	0xa4,				)
 INSTRUCTION_L( ,							 ,					,	0xa5,				)
 INSTRUCTION_E( "AND %s", 					4,   and_op			,	0xa7, {}			)
 ...
 INSTRUCTION_L( ,							 ,					,	0xac,				)
 INSTRUCTION_L( ,							 ,					,	0xad,				)
 INSTRUCTION_E( "XOR %s", 					4,   xor_op			,	0xaf, {}			)
 ...
 INSTRUCTION_L( ,							 ,					,	0xb4,				)
 INSTRUCTION_L( ,							 ,					,	0xb5,				)
 INSTRUCTION_E( "OR %s", 					4,   or_op			,	0xb7, {}			)
 ...
 INSTRUCTION_1( "AND 0x%02X", 				8,   and_op			,	0xe6, {}			)
 ...
 INSTRUCTION_0( "EI", 						4,   ei				,	0xfb, { cpu.clocks -= (numInstr - i - 1) * 4; i = numInstr; } )
 // INSTRUCTION_0( "UNKNOWN", 					0,   undefined		,	0xfc, {}			)
 // INSTRUCTION_0( "UNKNOWN", 					0,   undefined		,	0xfd, {}			)
 INSTRUCTION_1( "CP 0x%02X", 				8,	cp				,	0xfe, {}			)
