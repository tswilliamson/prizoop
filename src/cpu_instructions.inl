...
// description, tick count (in cpu clocks), function name, op id, special code
 ...
 INSTRUCTION_1( "STOP", 					4,   stop			,	0x10, LEAVE_LOOP	)
 ...
 INSTRUCTION_0( "HALT", 					4,   halt			,	0x76, LEAVE_LOOP	)
 INSTRUCTION_L( ,		 					 ,					,	0x78,				)
 INSTRUCTION_L( ,		 					 ,					,	0x79,				)
 INSTRUCTION_L( ,		 					 ,					,	0x7a,				)
 INSTRUCTION_L( ,		 					 ,					,	0x7b,				)
 ...
 INSTRUCTION_0( "RETI", 					16,  ret_i			,	0xd9, LEAVE_LOOP	)
 ...
 INSTRUCTION_0( "EI", 						4,   ei				,	0xfb, LEAVE_LOOP	)
