...
#define ALIGN_256 __attribute__((aligned(0x100)))

// various memory areas
extern unsigned char cart[0x8000] ALIGN_256;
extern unsigned char vram[0x2000] ALIGN_256;
extern unsigned char sram[0x2000] ALIGN_256;
extern unsigned char wram[0x2000] ALIGN_256;
extern unsigned char oam[0x100] ALIGN_256;
extern unsigned char hram_io[0x100] ALIGN_256;

// maps high byte to different spots in memory, guaranteed to be 0x100 aligned
extern unsigned char* memoryMap[256] ALIGN_256;
...
extern const unsigned char specialMap[256] ALIGN_256;
