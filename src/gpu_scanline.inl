...
template<class Type> inline void RenderScanline(void* scanlineStart) {
	...
	// if sprites enabled
	{
		const Type palette[8] = {
			ToScanType((Type) colorPalette[spritePalette[0][0]]),
			ToScanType((Type) colorPalette[spritePalette[0][1]]),
			ToScanType((Type) colorPalette[spritePalette[0][2]]),
			ToScanType((Type) colorPalette[spritePalette[0][3]]),
			ToScanType((Type) colorPalette[spritePalette[1][0]]),
			ToScanType((Type) colorPalette[spritePalette[1][1]]),
			ToScanType((Type) colorPalette[spritePalette[1][2]]),
