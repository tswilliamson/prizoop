...
// 0x8e
void res_1_hlp(void) { writeByte(cpu.registers.hl, cpu.registers.hl & ~(1 << 1)); }
...
// 0x96
void res_2_hlp(void) { writeByte(cpu.registers.hl, cpu.registers.hl & ~(1 << 2)); }
...
// 0x9e
void res_3_hlp(void) { writeByte(cpu.registers.hl, cpu.registers.hl & ~(1 << 3)); }
...
// 0xa6
void res_4_hlp(void) { writeByte(cpu.registers.hl, cpu.registers.hl & ~(1 << 4)); }
...
// 0xae
void res_5_hlp(void) { writeByte(cpu.registers.hl, cpu.registers.hl & ~(1 << 5)); }
...
// 0xb6
void res_6_hlp(void) { writeByte(cpu.registers.hl, cpu.registers.hl & ~(1 << 6)); }
